...
| DES-V1-003a | v1 card pool review: verify 16-card starter deck covers all 5 encounters adequately — fast early check before full balance pass | Hideo (Designer) | DES-V1-002 | N | Pending |
