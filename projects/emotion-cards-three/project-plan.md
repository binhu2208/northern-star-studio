...
| DES-001 | Define core emotional-state model with one concrete gameplay loop and screenshot-form emotion-state examples | Hideo | MKT-004 | Y | 🟡 In Progress |
...
| QA-001 | Define first-session usability goals and readability test checks | Sakura | MKT-004 | Y | 🟡 In Progress |
