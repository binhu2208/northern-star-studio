...
| ART-001 | Create early visual readability guide: card rules, icon draft, state color/shape system, screenshot legibility checklist | Yoshi | DES-001 | Y | 🟡 In Progress |
| DEV-001 | Prototype one playable combat scenario with emotional state system | John | DES-001 | Y | 🟡 In Progress |
| DEV-002 | Implement placeholder state UI and readability support for the prototype scenario | John | DEV-001, ART-001 | Y | 🔴 Pending |
| DES-002 | Define minimum vertical-slice scope and one polished archetype path | Hideo | DES-001, DEV-001 | Y | 🔴 Pending |
| QA-001 | Define first-session usability goals and readability test checks | Sakura | MKT-004 | Y | 🟢 Completed |
| QA-002 | Validate prototype against tactical clarity, fast state recognition, likely gameplay impact recognition, readability, and onboarding criteria | Sakura | DEV-002, QA-001, ART-001 | Y | 🔴 Pending |
